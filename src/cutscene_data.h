...
static const CsLine CS_0160_the_herder_LINES[] = {
    ...
    { "Distel", "Don't shout. You'll wake her. She's had a bad night.", 3, CS_TENSE, "portrait_distel.png", CS_LEFT, "" },
    ...
    { "Distel", "Mohn. You'd say night herder.", 5, CS_TENSE, "portrait_distel.png", CS_LEFT, "" },
    { "Ottilie", "I've heard of your people all my life. No one here has ever seen one.", 6, CS_WONDER, "portrait_lyra.png", CS_LEFT, "" },
    { "Distel", "Now you have. Move your foot. You're standing on my lead.", 6, CS_WONDER, "portrait_distel.png", CS_LEFT, "" },
    { "Distel", "Klee put them down. My drover  -  I raised him from a pup.", 6, CS_WONDER, "portrait_distel.png", CS_LEFT, "" },
    { "Ottilie", "What is a drover?", 6, CS_WONDER, "portrait_lyra.png", CS_LEFT, "" },
    { "Distel", "He beds a flock down where he thinks it's safe. He ran in the spring and stopped knowing me.", 6, CS_WONDER, "portrait_distel.png", CS_LEFT, "" },
    { "Falke", "He's the monster on my job sheet. I signed for him.", 7, CS_CONFRONT, "portrait_bron.png", CS_RIGHT, "" },
    { "Distel", "Then hold him still and I'll calm him. Quietly  -  she's sleeping.", 7, CS_CONFRONT, "portrait_distel.png", CS_LEFT, "" },
    { "Falke", "That's a sheep!", 7, CS_CONFRONT, "portrait_bron.png", CS_RIGHT, "" },
    { "Distel", "She has a name.", 7, CS_SORROW, "portrait_distel.png", CS_LEFT, "" },
};
...
static const CsLine CS_0180_what_was_on_it_LINES[] = {
    { "Distel", "He's dead. You killed him, and he'd have killed me. Both of those are true.", 1, CS_SORROW, "portrait_distel.png", CS_LEFT, "" },
    { "Falke", "I'm sorry. I didn't want to.", 1, CS_SORROW, "portrait_bron.png", CS_RIGHT, "" },
    { "Distel", "I know. Bring the lamp closer. Behind his ear.", 1, CS_SORROW, "portrait_distel.png", CS_LEFT, "" },
    { "Ottilie", "Nine of them, all the same size, healed shut years ago.", 2, CS_DREAD, "portrait_lyra.png", CS_LEFT, "" },
    { "Distel", "I've known him since he was a pup. I have never seen those.", 3, CS_DREAD, "portrait_distel.png", CS_LEFT, "" },
    { "Distel", "A drover does not forget his handler. Not ever.", 4, CS_DREAD, "portrait_distel.png", CS_LEFT, "" },
    { "Falke", "He forgot you.", 4, CS_DREAD, "portrait_bron.png", CS_RIGHT, "" },
    { "Distel", "So it was done to him. If it was done to mine, it was done to others.", 4, CS_DREAD, "portrait_distel.png", CS_LEFT, "" },
    ...
    { "Distel", "I'm going up to find out what was done to him. I don't need either of you.", 7, CS_HOPE, "portrait_distel.png", CS_LEFT, "" },
    { "Ottilie", "We're coming. Walk in the middle, you're asleep on your feet.", 7, CS_HOPE, "portrait_lyra.png", CS_LEFT, "" },
    { "Distel", "I'm going to cry soon. Keep walking.", 7, CS_SORROW, "portrait_distel.png", CS_LEFT, "" },
