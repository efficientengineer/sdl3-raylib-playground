# ChatGPT package: reference sheet for Dov
...
````
Create ONE image: a character reference sheet for Dov. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Dov's look in every scene.
- Save it as `story/refs/dov.png`. Every later `sheet` package attaches it automatically.
