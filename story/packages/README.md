...
**23 to do (3 of them a redraw of art that has gone stale), 8 already drawn and finished.**
...
| 6 | Distel | [`cast/distel/refsheet`](cast/distel/refsheet/prompt.md) | stale | the description it was drawn from has changed since |
...
| 13 | Distel | [`cast/distel/expressions`](cast/distel/expressions/prompt.md) | to generate | `ingest cast/distel/expressions` |
