# ChatGPT package: reference sheet for Ista
...
````
Create ONE image: a character reference sheet for Ista. Canvas: landscape, 1536x1024.
...
CHARACTER: Ista, a small neat woman who stands very straight, with pale skin, brown hair going white at the front and rolled up under a sage-green band, bright hazel eyes and a broad ready smile, three layers of plain brown and grey wool, a rose-madder shawl crossed and tucked at the waist, a small brass posting badge pinned at the collar, a strip of half-woven braid on a belt loom at her hip, and a paper of pins on a cord.
...
- Regenerate until you like the design. This image becomes Ista's look in every scene.
- Save it as `story/refs/ista.png`. Every later `sheet` package attaches it automatically.
