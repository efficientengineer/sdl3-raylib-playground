# ChatGPT package: reference sheet for Ovey
...
````
Create ONE image: a character reference sheet for Ovey. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Ovey's look in every scene.
- Save it as `story/refs/ovey.png`. Every later `sheet` package attaches it automatically.
