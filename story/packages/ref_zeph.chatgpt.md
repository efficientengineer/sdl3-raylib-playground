# ChatGPT package: reference sheet for Zeph
...
````
Create ONE image: a character reference sheet for Zeph. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Zeph's look in every scene.
- Save it as `story/refs/zeph.png`. Every later `sheet` package attaches it automatically.
