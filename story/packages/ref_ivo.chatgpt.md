# ChatGPT package: reference sheet for Ivo
...
````
Create ONE image: a character reference sheet for Ivo. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Ivo's look in every scene.
- Save it as `story/refs/ivo.png`. Every later `sheet` package attaches it automatically.
