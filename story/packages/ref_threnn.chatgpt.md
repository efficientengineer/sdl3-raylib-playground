# ChatGPT package: reference sheet for Threnn
...
````
Create ONE image: a character reference sheet for Threnn. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Threnn's look in every scene.
- Save it as `story/refs/threnn.png`. Every later `sheet` package attaches it automatically.
