# ChatGPT package: reference sheet for Maren
...
````
Create ONE image: a character reference sheet for Maren. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Maren's look in every scene.
- Save it as `story/refs/maren.png`. Every later `sheet` package attaches it automatically.
