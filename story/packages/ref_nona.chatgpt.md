# ChatGPT package: reference sheet for Nona
...
````
Create ONE image: a character reference sheet for Nona. Canvas: landscape, 1536x1024.
...
CHARACTER: Nona, a very short and very broad woman, wide through the shoulders, with clay-warm skin, amber eyes with bright rings at the pupils, pale gold hair standing straight up in a cropped brush, bare arms floured white to the elbow, a sleeveless square-cut overdress of faded woad-blue with a high banded collar and a row of bone toggles, a plain belted apron, and thin leather shoes — all of it very old, spotless, and invisibly mended.
...
- Regenerate until you like the design. This image becomes Nona's look in every scene.
- Save it as `story/refs/nona.png`. Every later `sheet` package attaches it automatically.
