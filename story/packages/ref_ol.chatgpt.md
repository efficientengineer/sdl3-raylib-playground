# ChatGPT package: reference sheet for Ol
...
````
Create ONE image: a character reference sheet for Ol. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Ol's look in every scene.
- Save it as `story/refs/ol.png`. Every later `sheet` package attaches it automatically.
