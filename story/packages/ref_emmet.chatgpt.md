# ChatGPT package: reference sheet for Emmet
...
````
Create ONE image: a character reference sheet for Emmet. Canvas: landscape, 1536x1024.
...
CHARACTER: Emmet, a mild, narrow-shouldered man of middle height with pale skin, mousy brown hair flattened into a side part, small round wire spectacles, a charcoal company coat with a stand collar, a brass number plate stitched at the throat and a mustard-yellow band around the left cuff, ink on both cuffs, a pencil behind one ear, and a clipboard on a string around his neck that he holds up like a shield.
...
- Regenerate until you like the design. This image becomes Emmet's look in every scene.
- Save it as `story/refs/emmet.png`. Every later `sheet` package attaches it automatically.
