# ChatGPT package: reference sheet for Ilven
...
````
Create ONE image: a character reference sheet for Ilven. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Ilven's look in every scene.
- Save it as `story/refs/ilven.png`. Every later `sheet` package attaches it automatically.
