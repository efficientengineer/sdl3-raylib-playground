# ChatGPT package: reference sheet for Neve
...
````
Create ONE image: a character reference sheet for Neve. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Neve's look in every scene.
- Save it as `story/refs/neve.png`. Every later `sheet` package attaches it automatically.
