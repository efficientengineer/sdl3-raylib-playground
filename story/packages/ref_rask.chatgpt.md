# ChatGPT package: reference sheet for Rask
...
````
Create ONE image: a character reference sheet for Rask. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Rask's look in every scene.
- Save it as `story/refs/rask.png`. Every later `sheet` package attaches it automatically.
