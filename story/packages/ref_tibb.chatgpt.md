# ChatGPT package: reference sheet for Tibb
...
````
Create ONE image: a character reference sheet for Tibb. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Tibb's look in every scene.
- Save it as `story/refs/tibb.png`. Every later `sheet` package attaches it automatically.
