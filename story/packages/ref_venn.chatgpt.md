# ChatGPT package: reference sheet for Venn
...
````
Create ONE image: a character reference sheet for Venn. Canvas: landscape, 1536x1024.
...
CHARACTER: Venn, a round, comfortable man of middle height with pale freckled skin, thinning ginger hair combed over, mild grey eyes and a permanent good-humoured half-smile, a charcoal company coat with a small brass number plate at the throat and a mustard-yellow band at the left cuff, a wide leather satchel on a cross-strap, ink on the right glove, and a ruled schedule board carried flat against his chest.
...
- Regenerate until you like the design. This image becomes Venn's look in every scene.
- Save it as `story/refs/venn.png`. Every later `sheet` package attaches it automatically.
