# ChatGPT package: reference sheet for Domma
...
````
Create ONE image: a character reference sheet for Domma. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Domma's look in every scene.
- Save it as `story/refs/domma.png`. Every later `sheet` package attaches it automatically.
