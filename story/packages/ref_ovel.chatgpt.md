# ChatGPT package: reference sheet for Ovel
...
````
Create ONE image: a character reference sheet for Ovel. Canvas: landscape, 1536x1024.
...
CHARACTER: Ovel, a tall, stooped man with pale skin and steel-grey hair swept back off a high forehead, deep-set pale eyes, a long bone-white sanatorium coat buttoned to a black stand collar over a charcoal suit, brass-ringed reading lenses pushed up onto his head, a ring of small brass keys on his belt, and a closed notebook held flat against his chest with both hands.
...
- Regenerate until you like the design. This image becomes Ovel's look in every scene.
- Save it as `story/refs/ovel.png`. Every later `sheet` package attaches it automatically.
