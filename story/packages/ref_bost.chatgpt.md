# ChatGPT package: reference sheet for Bost
...
````
Create ONE image: a character reference sheet for Bost. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Bost's look in every scene.
- Save it as `story/refs/bost.png`. Every later `sheet` package attaches it automatically.
