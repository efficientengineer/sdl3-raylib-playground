# ChatGPT package: reference sheet for Hallet
...
````
Create ONE image: a character reference sheet for Hallet. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Hallet's look in every scene.
- Save it as `story/refs/hallet.png`. Every later `sheet` package attaches it automatically.
