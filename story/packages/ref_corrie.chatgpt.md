# ChatGPT package: reference sheet for Corrie
...
````
Create ONE image: a character reference sheet for Corrie. Canvas: landscape, 1536x1024.
...
CHARACTER: Corrie, a small, quick girl of seventeen with brown skin, black hair tied in two short high tails, big dark eyes and a bright unwavering smile, a charcoal company shop coat with a brass number plate stitched at the throat, a bright pink counter apron with rows of narrow pockets holding paper sleeves, fingerless cotton gloves, and a shallow wooden tray carried level at her waist.
...
- Regenerate until you like the design. This image becomes Corrie's look in every scene.
- Save it as `story/refs/corrie.png`. Every later `sheet` package attaches it automatically.
