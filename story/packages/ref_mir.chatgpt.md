# ChatGPT package: reference sheet for Mir
...
````
Create ONE image: a character reference sheet for Mir. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Mir's look in every scene.
- Save it as `story/refs/mir.png`. Every later `sheet` package attaches it automatically.
