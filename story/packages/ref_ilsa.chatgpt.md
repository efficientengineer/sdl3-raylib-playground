# ChatGPT package: reference sheet for Ilsa
...
````
Create ONE image: a character reference sheet for Ilsa. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Ilsa's look in every scene.
- Save it as `story/refs/ilsa.png`. Every later `sheet` package attaches it automatically.
