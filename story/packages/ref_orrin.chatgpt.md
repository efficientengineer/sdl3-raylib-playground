# ChatGPT package: reference sheet for Orrin
...
````
Create ONE image: a character reference sheet for Orrin. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Orrin's look in every scene.
- Save it as `story/refs/orrin.png`. Every later `sheet` package attaches it automatically.
