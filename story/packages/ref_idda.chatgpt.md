# ChatGPT package: reference sheet for Idda
...
````
Create ONE image: a character reference sheet for Idda. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Idda's look in every scene.
- Save it as `story/refs/idda.png`. Every later `sheet` package attaches it automatically.
