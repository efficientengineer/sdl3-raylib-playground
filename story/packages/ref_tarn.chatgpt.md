# ChatGPT package: reference sheet for Tarn
...
````
Create ONE image: a character reference sheet for Tarn. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Tarn's look in every scene.
- Save it as `story/refs/tarn.png`. Every later `sheet` package attaches it automatically.
