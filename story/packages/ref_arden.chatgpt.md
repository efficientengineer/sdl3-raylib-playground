# ChatGPT package: reference sheet for Arden
...
````
Create ONE image: a character reference sheet for Arden. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Arden's look in every scene.
- Save it as `story/refs/arden.png`. Every later `sheet` package attaches it automatically.
