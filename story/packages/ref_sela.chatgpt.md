# ChatGPT package: reference sheet for Sela
...
````
Create ONE image: a character reference sheet for Sela. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Sela's look in every scene.
- Save it as `story/refs/sela.png`. Every later `sheet` package attaches it automatically.
