# ChatGPT package: reference sheet for Corrow
...
````
Create ONE image: a character reference sheet for Corrow. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Corrow's look in every scene.
- Save it as `story/refs/corrow.png`. Every later `sheet` package attaches it automatically.
