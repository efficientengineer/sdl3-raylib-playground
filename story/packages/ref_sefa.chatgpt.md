# ChatGPT package: reference sheet for Sefa
...
````
Create ONE image: a character reference sheet for Sefa. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Sefa's look in every scene.
- Save it as `story/refs/sefa.png`. Every later `sheet` package attaches it automatically.
