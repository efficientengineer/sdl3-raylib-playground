# ChatGPT package: reference sheet for Stobb
...
````
Create ONE image: a character reference sheet for Stobb. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Stobb's look in every scene.
- Save it as `story/refs/stobb.png`. Every later `sheet` package attaches it automatically.
