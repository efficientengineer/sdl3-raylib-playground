# Garbe — reference sheet — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/cast/garbe/refsheet/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
...
- `story/refs/garbe.png`
- `story/portraits/garbe.png`
