# ChatGPT package: Hart — expression sheet
...
1. `story/packages/cast/hart/expressions/template.png`
...
Image 3: CHARACTER reference for Hart. Every slot is this character: keep the face, hair, colours, collar and marks identical to the middle panel of this sheet. Use it for the design only — ignore its background, its three-panel layout and its neutral expression, which is only slot 1.
...
`story/packages/cast/hart/expressions/returned.png`. A .jpg or .webp works too; the tool converts it.

Then cut it up, from the repository root:

```
./story_prompt.py ingest story/packages/cast/hart/expressions
```

That writes `story/portraits/hart_neutral.png`, `story/portraits/hart_smile.png`, `story/portraits/hart_laugh.png`, `story/portraits/hart_biglaugh.png`, `story/portraits/hart_concern.png`, `story/portraits/hart_sorrow.png`, `story/portraits/hart_annoyed.png`, `story/portraits/hart_angry.png`, `story/portraits/hart_shock.png`, `story/portraits/hart_resolve.png`. Running `./story_prompt.py ingest` with no path does every package in
