# villager_a — walk sheet (no cast entry) — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/cast/villager_a/walker/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
...
- `story/field/walkers/villager_a.png`
