# ChatGPT package: Distel — reference sheet
...
````
Create ONE image: a character reference sheet for Distel. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Distel's look in every scene,
...
`story/packages/cast/distel/refsheet/returned.png`. A .jpg or .webp works too; the tool converts it.
...
That writes `story/refs/distel.png` and the dialogue-box portrait cut out of it. Running `./story_prompt.py ingest` with no path does every package in
