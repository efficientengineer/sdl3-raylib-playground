# ChatGPT package: Distel — expression sheet
...
1. `story/packages/cast/distel/expressions/template.png`
2. `story/refs/style.png`
3. `story/refs/distel.png`
...
Image 3: CHARACTER reference for Distel. Every slot is this character: keep the face, hair, colours, collar and marks identical to the middle panel of this sheet. Use it for the design only — ignore its background, its three-panel layout and its neutral expression, which is only slot 1.
...
`story/packages/cast/distel/expressions/returned.png`. A .jpg or .webp works too; the tool converts it.
...
That writes `story/portraits/distel_neutral.png`, `story/portraits/distel_smile.png`, `story/portraits/distel_laugh.png`, `story/portraits/distel_biglaugh.png`, `story/portraits/distel_concern.png`, `story/portraits/distel_sorrow.png`, `story/portraits/distel_annoyed.png`, `story/portraits/distel_angry.png`, `story/portraits/distel_shock.png`, `story/portraits/distel_resolve.png`. Running `./story_prompt.py ingest` with no path does every package in
