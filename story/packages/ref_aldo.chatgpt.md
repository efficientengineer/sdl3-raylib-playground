# ChatGPT package: reference sheet for Aldo
...
````
Create ONE image: a character reference sheet for Aldo. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Aldo's look in every scene.
- Save it as `story/refs/aldo.png`. Every later `sheet` package attaches it automatically.
