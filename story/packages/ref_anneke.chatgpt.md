# ChatGPT package: reference sheet for Anneke
...
````
Create ONE image: a character reference sheet for Anneke. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Anneke's look in every scene.
- Save it as `story/refs/anneke.png`. Every later `sheet` package attaches it automatically.
