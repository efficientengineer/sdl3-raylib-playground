# ChatGPT package: reference sheet for Jory
...
````
Create ONE image: a character reference sheet for Jory. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Jory's look in every scene.
- Save it as `story/refs/jory.png`. Every later `sheet` package attaches it automatically.
