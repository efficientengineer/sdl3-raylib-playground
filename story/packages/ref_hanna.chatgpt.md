# ChatGPT package: reference sheet for Hanna
...
````
Create ONE image: a character reference sheet for Hanna. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Hanna's look in every scene.
- Save it as `story/refs/hanna.png`. Every later `sheet` package attaches it automatically.
