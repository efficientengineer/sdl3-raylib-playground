# ChatGPT package: reference sheet for Ondra
...
````
Create ONE image: a character reference sheet for Ondra. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Ondra's look in every scene.
- Save it as `story/refs/ondra.png`. Every later `sheet` package attaches it automatically.
