# ChatGPT package: reference sheet for Bex
...
````
Create ONE image: a character reference sheet for Bex. Canvas: landscape, 1536x1024.
...
CHARACTER: Bex, a very short and very broad older woman, half again as wide through the shoulders as a human her height, with clay-warm skin, amber eyes with bright rings at the pupils, brass-coloured hair standing up in a stiff cropped brush, a sleeveless slate-blue roofkeeper's coat over a cream underlayer, bare arms, a wide belt of tank tools, a brass water-meter key on a cord at her hip, and flat boots dusted with sandstone.
...
- Regenerate until you like the design. This image becomes Bex's look in every scene.
- Save it as `story/refs/bex.png`. Every later `sheet` package attaches it automatically.
