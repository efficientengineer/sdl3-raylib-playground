# ChatGPT package: reference sheet for Mira
...
````
Create ONE image: a character reference sheet for Mira. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Mira's look in every scene.
- Save it as `story/refs/mira.png`. Every later `sheet` package attaches it automatically.
