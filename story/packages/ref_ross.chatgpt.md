# ChatGPT package: reference sheet for Ross
...
````
Create ONE image: a character reference sheet for Ross. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Ross's look in every scene.
- Save it as `story/refs/ross.png`. Every later `sheet` package attaches it automatically.
