# ChatGPT package: reference sheet for Dalla
...
````
Create ONE image: a character reference sheet for Dalla. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Dalla's look in every scene.
- Save it as `story/refs/dalla.png`. Every later `sheet` package attaches it automatically.
