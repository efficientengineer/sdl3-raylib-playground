# ChatGPT package: reference sheet for Cassa
...
````
Create ONE image: a character reference sheet for Cassa. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Cassa's look in every scene.
- Save it as `story/refs/cassa.png`. Every later `sheet` package attaches it automatically.
