# ChatGPT package: reference sheet for Hesk
...
````
Create ONE image: a character reference sheet for Hesk. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Hesk's look in every scene.
- Save it as `story/refs/hesk.png`. Every later `sheet` package attaches it automatically.
