...
0 of 3 files in this package have been cut already.

- slot 1 `story/field/props/bedroll.png` — missing
- slot 2 `story/field/props/campfire.png` — missing
- slot 3 `story/field/props/ridge_rock.png` — missing
