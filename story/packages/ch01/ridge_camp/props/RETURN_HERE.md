# ridge_camp — 3 props — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/ch01/ridge_camp/props/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
...
- `story/field/props/bedroll.png`
- `story/field/props/campfire.png`
- `story/field/props/ridge_rock.png`
