# field sprites — 3 billboard(s) (1 of 3) — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/ch01/sprites/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
3. From the repository root:

```
./story_prompt.py ingest story/packages/ch01/sprites
```

That cuts the image into:

- `story/field/sprites/burr.png`
- `story/field/sprites/false_lantern.png`
- `story/field/sprites/fleece.png`
