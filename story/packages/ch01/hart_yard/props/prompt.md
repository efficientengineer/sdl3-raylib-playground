...
- slot 1 `story/field/props/practice_post.png` — **exists**

## 1. Start a new chat and attach these files, in this order

1. `story/packages/ch01/hart_yard/props/template.png`
...
`story/packages/ch01/hart_yard/props/returned.png`. A .jpg or .webp works too; the tool converts it.
