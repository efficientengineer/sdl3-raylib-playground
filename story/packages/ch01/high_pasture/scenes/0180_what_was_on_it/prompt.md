# ChatGPT package: 0180_what_was_on_it — shot sheet
...
- `story/panels/0180_what_was_on_it_p3_full_body_reveal.png` — missing
- `story/panels/0180_what_was_on_it_p4_portrait_inset.png` — missing
...
Panel 3: a tall narrow vertical panel, exactly twice as tall as it is wide (1:2). Left edge at 11%, right edge at 35%, top edge at 22%, bottom edge at 49%.
Panel 4: a small perfectly square panel (1:1), the smallest panel on the sheet. Left edge at 41%, right edge at 65%, top edge at 22%, bottom edge at 36%.
...
`story/packages/ch01/high_pasture/scenes/0180_what_was_on_it/returned.png`. A .jpg or .webp works too; the tool converts it.

Then cut it up, from the repository root:

```
./story_prompt.py ingest story/packages/ch01/high_pasture/scenes/0180_what_was_on_it
```
