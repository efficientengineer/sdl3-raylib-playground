# north_grass — 2 tiles — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/ch01/north_grass/tiles/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
...
- `story/field/tiles/grass_tall.png`
- `story/field/tiles/scree.png`
