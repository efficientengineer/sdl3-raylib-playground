# north_grass — 2 props — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/ch01/north_grass/props/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
...
- `story/field/props/cave_mouth.png`
- `story/field/props/slide_rubble.png`
