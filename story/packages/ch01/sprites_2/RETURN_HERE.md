# field sprites — 4 billboard(s) (2 of 3) — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/ch01/sprites_2/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
3. From the repository root:

```
./story_prompt.py ingest story/packages/ch01/sprites_2
```

That cuts the image into:

- `story/field/sprites/job_board.png`
- `story/field/sprites/klee.png`
- `story/field/sprites/lid.png`
- `story/field/sprites/machine_arm.png`
