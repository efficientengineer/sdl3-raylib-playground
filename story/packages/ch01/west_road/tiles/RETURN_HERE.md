# west_road — 4 tiles — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/ch01/west_road/tiles/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
...
- `story/field/tiles/old_road.png`
- `story/field/tiles/river_bank.png`
- `story/field/tiles/road.png`
- `story/field/tiles/water.png`
