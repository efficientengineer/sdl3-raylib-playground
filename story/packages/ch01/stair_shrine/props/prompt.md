...
- slot 1 `story/field/props/rubbing_stall.png` — missing
- slot 2 `story/field/props/shrine_house.png` — missing
- slot 3 `story/field/props/sitter.png` — missing
- slot 4 `story/field/props/step_rope.png` — missing
- slot 5 `story/field/props/stone_shelf.png` — missing
- slot 6 `story/field/props/water_jar.png` — missing
