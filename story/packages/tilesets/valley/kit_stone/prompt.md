# ChatGPT package: valley — the 'stone' building kit (28 pieces)

## What exists already

- `stone` kit, 28 pieces at atlas index 448-475

## 1. Start a new chat and attach these files, in this order

1. `story/packages/tilesets/valley/kit_stone/template.png`
...
THE STYLE OF THIS KIT: grey fieldstone walls of uneven blocks with pale mortar, a heavy grey slate roof, deep-set narrow windows, iron-strapped doors, the oldest and most solid building in the valley
...
`story/packages/tilesets/valley/kit_stone/returned.png`. A .jpg or .webp works too; the tool converts it.
