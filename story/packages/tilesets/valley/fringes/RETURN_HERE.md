# valley — fringes tile sheet — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/tilesets/valley/fringes/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
...
- `story/field/tilesets/valley/cut/fringes.png`
