# ChatGPT package: valley — the 'timber' building kit (28 pieces)

## What exists already

- `timber` kit, 28 pieces at atlas index 416-443

## 1. Start a new chat and attach these files, in this order

1. `story/packages/tilesets/valley/kit_timber/template.png`
...
THE STYLE OF THIS KIT: dark tarred plank walls with wide boards, a low fieldstone base, a thick golden thatch roof with a bound ridge, plain heavy plank doors, a working barn or a store rather than a home
...
`story/packages/tilesets/valley/kit_timber/returned.png`. A .jpg or .webp works too; the tool converts it.
