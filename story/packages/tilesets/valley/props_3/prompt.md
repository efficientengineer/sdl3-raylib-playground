# ChatGPT package: valley — props_3 tile sheet (3 of 3)

## What exists already

- `story/field/tilesets/valley/atlas.png` — not started yet
- `story/field/tilesets/valley/cut/props_3.png` — not cut yet

This sheet carries 1 of the tileset's entries: `guild_hall`

## 1. Start a new chat and attach these files, in this order

1. `story/packages/tilesets/valley/props_3/template.png`
...
WHAT THIS SHEET IS: the 'props_3' tile sheet for the 'valley' tileset of a top-down 16-bit JRPG field map. Every slot is one tile or one multi-tile object, and in game each tile is exactly 32x32 pixels.
...
`story/packages/tilesets/valley/props_3/returned.png`. A .jpg or .webp works too; the tool converts it.

Then cut it up, from the repository root:

```
./story_prompt.py ingest story/packages/tilesets/valley/props_3
```
