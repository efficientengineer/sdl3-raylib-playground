# valley — ground tile sheet — save the image here
...
2. Save what ChatGPT gives back **into this folder**, named `returned.png`.
   The whole path is `story/packages/tilesets/valley/ground/returned.png`. A `.jpg` or `.webp` works too; the tool converts it.
...
- `story/field/tilesets/valley/cut/ground.png`
