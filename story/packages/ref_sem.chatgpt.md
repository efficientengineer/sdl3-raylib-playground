# ChatGPT package: reference sheet for Sem
...
````
Create ONE image: a character reference sheet for Sem. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Sem's look in every scene.
- Save it as `story/refs/sem.png`. Every later `sheet` package attaches it automatically.
