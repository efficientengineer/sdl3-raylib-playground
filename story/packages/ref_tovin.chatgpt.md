# ChatGPT package: reference sheet for Tovin
...
````
Create ONE image: a character reference sheet for Tovin. Canvas: landscape, 1536x1024.
...
- Regenerate until you like the design. This image becomes Tovin's look in every scene.
- Save it as `story/refs/tovin.png`. Every later `sheet` package attaches it automatically.
