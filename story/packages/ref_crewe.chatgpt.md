# ChatGPT package: reference sheet for Crewe
...
````
Create ONE image: a character reference sheet for Crewe. Canvas: landscape, 1536x1024.
...
CHARACTER: Crewe, a very tall, thinned-out old man who stoops a little, with pale skin, white hair combed flat, pale blue eyes, a long charcoal coat that hangs loose on him over a deep burgundy waistcoat and a high white collar, a black stock at the throat, a brass company seal on a chain at his breast, and a black cane with a brass ferrule which he holds in both hands and taps once before he speaks.
...
- Regenerate until you like the design. This image becomes Crewe's look in every scene.
- Save it as `story/refs/crewe.png`. Every later `sheet` package attaches it automatically.
