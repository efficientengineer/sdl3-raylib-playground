...
7. full_body_reveal | {{MENTOR}} head to boots crossing the yard from a low angle, a plain straight sword in a worn scabbard hanging from one hand, a rag in the other, his knee brace and apron in the last light
   - {{MENTOR}}: eyes right on {{HERO}}, chin low, mouth flat, walking, the sword carried like a finished tool
8. two_shot | the sword held out hilt first in {{MENTOR}}'s one hand at the left and {{HERO}}'s hand closing on the grip at the right, the leather rubbed dark in the middle, the town small below
   - {{MENTOR}}: eyes right on {{HERO}}, arm out straight, the rag still in his other fist
   - {{HERO}}: eyes down on the sword between them, mouth open on nothing, fingers not closed on it yet
...
- {{HEALER}} (biglaugh) [6]: No. You'd have it framed.
- {{MENTOR}} (neutral) [7] {hope}: Put the stick down.
- {{MENTOR}} (neutral) [7]: Made it the winter before last.
- {{HERO}} (shock) [8]:
- {{HERO}} (smile) [8]: I can sign tonight.
- {{HEALER}} (smile) [8]: It suits you.
- {{MENTOR}} (resolve) [8]: Take it to the clerk. He'll write your name in the guild book.
- {{HEALER}} (neutral) [8] {tense}: {{HERO}}. That's the evening bell.
