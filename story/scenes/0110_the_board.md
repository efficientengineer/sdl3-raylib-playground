# Scene 0110: The Board

- map: halm
- location: the guild hall of {{HOME_TOWN}}: a long low stone room with a plank counter, a double doorway standing open on a late afternoon street, and a bare job board on the wall behind the counter
- characters: {{HERO}}, Guildclerk
- mood: out of breath, then decided
- staging: {{HERO}} stands at the counter on the left of the screen facing right. The Guildclerk stands behind the counter on the right facing left. The job board with its one last sheet is on the wall behind him, on the right. Both of them keep coming back to that sheet
- dialogue_box: no
...
2. two_shot | {{HERO}} at the plank counter inside the hall, Guildclerk behind it with both hands flat on an open ledger, the emptied board on the wall behind them
   - {{HERO}}: eyes on the Guildclerk, mouth open mid-question, chest heaving, one fist on the counter
   - Guildclerk: looking down at the ledger, brows raised, unhurried, one finger holding his place on the page
3. object_insert | one sheet of paper hanging from a single nail on an empty plank board, its lower corner curled, the wood around it pocked with old nail holes
---
4. portrait_inset | {{HERO}} in close-up at the counter, the hour he lost landing on him
   - {{HERO}}: eyes cut right to the Guildclerk, brows crushed down in a V, teeth showing, chin low
5. over_shoulder | the dark back of {{HERO}}'s head and shoulder at the left edge, Guildclerk beyond the counter holding the last sheet up between two fingers
   - {{HERO}}: seen from behind, head turned right, facing the Guildclerk, shoulders squared, both fists on the counter
   - Guildclerk: looking at the sheet in his own hand, chin lifted, reciting, his other hand flat behind his back
6. eyes_slit | {{HERO}}'s eyes and brow filling the panel edge to edge, doorway light across them
