# Scene 0935: Where Were You Born

- type: talk
- location: a crescent of patched canvas and plank shelters on salt, a shared fire pit of packed salt bricks, a water barrel on a sled, washing on a rope, cold blue dusk, firelight from the centre
- characters: Bron, Lyra, Hesk
- backdrop: 0930_ostry_bar:4
- mood: cheerful, and the player does the work

## Beat
Bron asks people where they are from, which is the most ordinary question there is, and gets cheerful
...
- Camp woman: Salt company. It comes off the wage, and the wage comes off them. Very tidy, that.
- Bron {sorrow}: Thank you. We'll leave you to your evening.
