# THREADS — what finished chapters have promised the player

Discovery writing (D23) has no outline to catch a dropped setup, so this file does. One line per thing a
finished chapter has put in the player's head and not yet answered. Add when a chapter is approved;
strike through when paid. Nothing here is a plan for HOW it is answered.

The first draft's threads — the jar of well water, the woman under the bottom step, {{FATHER}}'s
twenty years of talking to her, the moon that moved, the carters walking west, {{MENTOR}}'s eleven
...
- Behind {{BEAST_NAME}}'s left ear there is a ring of nine small holes in the skin, all the same
  size, healed shut years ago. Somebody made them. **What are they, who made them, and when?**
- A {{GUARD_BEAST}} does not forget its handler. This one did. **What was done to him?**
- {{HERDER}}'s answer to both is "go up the mountain and find out", which is where chapter two goes.
  If it was done to hers, it was done to others — **how many others, and are any of them still out?**

**Smaller, and answerable any time:**
